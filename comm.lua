...
function respondToMessage(event)   
    ...
    local messageResponses = {                      -- Table specfifying the appropriate response to each message description
        ...
        ["NewStudentAccept"] = function(peer, classname) AcceptNewStudent(peer, forename, surname, email, classname) end,
...
function AcceptNewStudent(peer, forename, surname, email, classname)
